        ...
        <div className="pb-20">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 stagger-sm">
                        ...
                        <Card>
                            <CardBody>
                                ...
                                <p className="text-sm text-black/70 dark:text-white/70">
                                    新しいことを学ぶとき、具体例から入りますか？それとも概念から考えますか？
                                </p>
                            </CardBody>
                        </Card>
                        <Card>
                ...
                <InView effect="slide-left" className="mx-auto max-w-6xl">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 stagger-sm">
                        {[
                            ...
                            <div
                                key={t}
                                className="rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/10 backdrop-blur-md px-3 py-2 text-center"
                            >
                        ...
                        <CardBody>
                            <div className="flex flex-col md:flex-row items-center justify-between gap-3">
                                <div className="text-center md:text-left">
                                    ...
                                    <div className="text-xs md:text-sm text-black/60 dark:text-white/60">
                                        30問でMBTI＋Big
                                        Fiveを推定し、あなたの物語をより精密に。
                                    </div>
                                </div>
            ...
            <Section>
                <InView effect="slide-up" className="mx-auto max-w-3xl text-center space-y-4">
                    ...
                    <div className="flex items-center justify-center gap-3">
                        <Link href="/chat">
                            <Button size="lg">簡易診断をはじめる</Button>
                        </Link>
                        <Link href="/detail">
                            <Button variant="secondary" size="lg">
                                詳細診断を見る
