...
const QUESTIONS: Question[] = [
    ...
    ),
    {
        id: 'C31',
        section: 'OPEN',
        text: '【自由記述】最近、自分らしさを感じた場面を具体的に教えてください',
        type: 'text',
        axis: 'OpenText',
        weight: 1.0,
    },
